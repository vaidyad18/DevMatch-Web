...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="w-full max-w-[400px] mx-auto rounded-3xl overflow-hidden shadow-lg bg-[#0b0b0b]/90 backdrop-blur-3xl  border border-gray-800 hover:shadow-2xl transition flex flex-col select-none">
